...
<div class="container-fluid mt-5 bg-dark-subtle rounded p-4" style="width: 65%">
    <div class="container-fluid bg-dark rounded my-2 p-1" style="width: 98%">
        <h3 class="text-center text-white mt-2 mb-3">Página Inicial</h3>
        <p class="text-center px-3">
            Aqui estão alguns produtos! Veja mais na página <a href="?p=produtos">Produtos.</a>
            <br>
            Nossa equipe apenas seleciona processadores de qualidade para sua jogatina ou trabalho.
        </p>
